...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义 - 基于SysConfig生成的配置

#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(HW_ID_HW_AD0_PORT, HW_ID_HW_AD0_PIN)) : (DL_GPIO_clearPins(HW_ID_HW_AD0_PORT, HW_ID_HW_AD0_PIN)))  // 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(HW_ID_HW_AD1_PORT, HW_ID_HW_AD1_PIN)) : (DL_GPIO_clearPins(HW_ID_HW_AD1_PORT, HW_ID_HW_AD1_PIN)))  // 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(HW_ID_HW_AD2_PORT, HW_ID_HW_AD2_PIN)) : (DL_GPIO_clearPins(HW_ID_HW_AD2_PORT, HW_ID_HW_AD2_PIN)))  // 地址位2控制

// ADC值获取接口宏定义 - 基于SysConfig生成的配置
